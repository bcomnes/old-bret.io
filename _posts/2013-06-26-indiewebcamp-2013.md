...
<img class="pull-right" width="261" height="498" src="https://farm4.staticflickr.com/3717/9157793342_8c0b1c266e_o.png"></img>
...
Webfinger lets you attach arbitrary information to an email address.  This is done by relying on the email host to implement Webfinger.  Examples of information you might want associated with your email address.
...
<img class="pull-right" width="261" height="498" src="http://farm3.staticflickr.com/2807/9157907602_c9d5926a8a_o.png"></img>
...
- [sandeep.io](http://www.sandeep.io/73) (featuring Indie "Likes"!)
- [werd.io](http://werd.io/view/51c8fc19bed7de5e23600fb1)
- [willnorris.com](https://willnorris.com/2013/06/testing-indieweb-comments)

Some implementations display like a traditional comment system, other follow the twitter UX for handling replies.  Some people are even experimenting with threads.  The key to success here is that everyone is [selfdogfooding](http://indiewebcamp.com/selfdogfood).
...
<img class="pull-right" width="261" height="498" src="http://farm8.staticflickr.com/7385/9155902415_53114141a4_o.png"></img>
...
Hats off to Ben and the [Idno](http://idno.co/) project for is impressive speed at implementing these important concepts.  [Aaron already has is RSVP](http://aaronparecki.com/replies/2013/06/27/1/indieweb) implementation working!

This stuff is developing fast!  Just this evening [Aaron implemented IndieWeb IRC repliess](http://aaronparecki.com/replies/2013/06/28/1/indieweb)
...
[Brad](http://bradfitz.com/) gave a talk on [Camlistore](https://camlistore.org/).  It appears to be way to store data in some kind of blob tree which offers a lot of flexibility on how it can be accessed and stored.  It also sounds like it could enable distributed file sharing in really interesting ways.  Apparently you will eventually be able to rent out space to others for Bitcoins.
...
<img class="pull-right" width="261" height="498" src="http://farm4.staticflickr.com/3716/9155969247_91e0319a12_o.png"></img>

I missed the discussion on this project, and I wish I hadn't.   The [Smallest-Federated-Wiki](http://fed.wiki.org/welcome-visitors.html) is a wiki that allows anyone to fork pages on their own instance of the wiki, and allows others to pull those changes in...  I think.  The implementation looks really slick and has a lot of interesting client side stuff going on.  Check out some of the [demo videos](http://wardcunningham.github.io/).

## IFTTT Everything
[Paul Fenwick](https://twitter.com/pjf) led an interesting discussion and gave some demos about implementing APIs, data collection and actions where there previously was nothing.
...
<img class="img-polaroid" src="http://farm3.staticflickr.com/2889/9109842488_ac540f585f_b.jpg"></img>
...
Here are some topics I would like to see more of next year.

### IRC Brainstorm

[IRC](http://indiewebcamp.com/IRC) plays an integral role in developing these projects, as it serves as one of the primary channels of real-time communication.  It can be tough for new users and the software is hard to use in many cases.

I would like to have some discussions about how people use IRC in relation to the IndieWeb, as well as look for new uses for this communications tool.

We could also just demo everyones exotic IRC setups.

### Static Site Session

Static websites are easy, and I would like to discuss how people are participating in the indieweb without just static HTML and client side JS.  I am primarily curious how others over come some of the challenges of doing everything at compile time, as well as sharing what I have found in my experiments.

# How I can contribute going forward

Here are some things that I hope to work on before the next conference.

### Implement posting types that interest me

Not all of the posting types interest me.  I need to implement the post types I want, and do a really solid job on the implementation.

### Start displaying Webmentions/Pingbacks using [Pingback.me](http://pingback.me/)

Starting small, I want to give some kind of indication that someone has sent me a webmention or pingback on the pingback.me service.  I think I will be able to do this using vanilla JS.

### Look into unhosted posting methods

Finding out about projects like [Unhosted](https://unhosted.org/) gives me some hope that eventually, I could implement an unfrosted posted system directly to github pages. 
